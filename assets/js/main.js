...
let header = $(`
<nav class="navbar navbar-expand-lg navbar-light fixed-top nav1" style="z-index: 9999" id="navbar">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent1">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <b><a class="nav-link text-white px-3" href="index.html">Home</a></b>
      </li>
      <li class="nav-item active">
        <b><a class="nav-link text-white px-3" href="index.html#about-intro">About</a></b>
      </li>
      <li class="nav-item active">
        <b><a class="nav-link text-white px-3" href="index.html#team">Team</a></b>
      </li>
      <li class="nav-item active">
        <b><a class="nav-link text-white px-3" href="index.html#contact">Contact</a></b>
      </li>
      <li class="nav-item active">
        <b><a class="nav-link text-white px-3" href="editor.html">Editor</a></b>
      </li>
    </ul>
  </div>
</nav>`);
